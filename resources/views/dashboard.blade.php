    ...
    <div class="main-wrapper">
        ...
        <div class="container main-content">
            ...
            <script>
                ...
                new Chart(ctxR, {type: 'line', data: {labels: months, datasets:[{label:'Penerimaan', data: receipts, borderColor:'#22c55e', backgroundColor:'rgba(34,197,94,0.08)', tension:0.3}]}, options:{responsive:true}});

                const ctxI = document.getElementById('chartIssues').getContext('2d');
                new Chart(ctxI, {type: 'line', data: {labels: months, datasets:[{label:'Pengeluaran', data: issues, borderColor:'#6366f1', backgroundColor:'rgba(99,102,241,0.08)', tension:0.3}]}, options:{responsive:true}});

                const ctxT = document.getElementById('chartTopUsed').getContext('2d');
                new Chart(ctxT, {type: 'bar', data: {labels: topLabels, datasets:[{label:'Jumlah Keluar', data: topData, backgroundColor:'#fb923c'}]}, options:{indexAxis:'y', responsive:true}});
            </script>
            @endif
        </div>
    </div>
