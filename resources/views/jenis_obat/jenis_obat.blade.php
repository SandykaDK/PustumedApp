            ...
            <div class="table-actions">
                <form method="GET" action="{{ route('jenis-obat.index') }}">
                    <div class="search-wrapper">
                        ...
                        <a href="{{ route('jenis-obat.index') }}" class="btn-reset" style="display:flex;align-items:center;gap:6px;background:#6b7280;color:white;padding:8px 14px;border-radius:6px;text-decoration:none;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    @if ($jenisobat->nama_obat_count > 0)
...
<script>
    (function() {
        ...
        const createForm = document.querySelector('#createJenisModal form');
